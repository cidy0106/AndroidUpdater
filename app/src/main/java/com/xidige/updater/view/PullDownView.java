...
public class PullDownView extends LinearLayout implements OnScrollOverListener, OnScrollListener {
	...
	private static SimpleDateFormat dateFormat =(SimpleDateFormat) SimpleDateFormat.getDateTimeInstance();// new SimpleDateFormat("MM-dd HH:mm");
...
//	private Field overScrollModeField;
	...
	private void updateHeader() {
		if ((state & STATE_REFRESHING) == STATE_REFRESHING) {
			...
			mHeaderTextView.setText(R.string.pulldown_refreshing);
			...
			if(mHeaderViewParams.height >= mDefaultHeaderViewHeight){
				...
				mHeaderTextView.setText(R.string.pulldown_refreshrelease);
				...
				mHeaderTextView.setText(R.string.pulldown_refreshpulldown);
			...
			mHeaderArrowView.setVisibility(View.VISIBLE);
			mHeaderTextView.setText(R.string.pulldown_refreshpulldown);
			mHeaderViewDateView.setText(mContext.getString(R.string.pulldown_updatedtime) + dateFormat.format(new Date()));
		}
	}
	...
	private void updateFooter() {
		...
		if (mIsNoMoreData) {
			mFooterTextView.setText(R.string.pulldown_loadover);
			mFooterLoadingView.setVisibility(View.GONE);
		} else if ((state & STATE_LOADING_MORE) == STATE_LOADING_MORE) {
			mFooterTextView.setText(R.string.pulldown_loadingmore);
			mFooterLoadingView.setVisibility(View.VISIBLE);
		} else {
			mFooterTextView.setText(R.string.pulldown_more);
			mFooterLoadingView.setVisibility(View.GONE);
		}
	}
